            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="max-w-3xl mt-8 gap-2 flex flex-col items-center">
                        <h2 className="font-semibold text-gray-700 dark:text-white text-xl">{subTitleAboutMe}</h2>
                        <p className="text-slate-500 dark:text-white items-center flex text-justify max-w-[70%] text-sm">
